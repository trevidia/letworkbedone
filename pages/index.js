    ...
    {/*    End of Header */}
        <main className={"w-full py-10"}>
            ...
            <section className={"py-10 flex-col-center"}>
                ...
                <button className={"bg-primary h-12 w-80 rounded-md text-white mt-3 text-sm uppercase font-semibold border-4 border-transparent hover:border-primary hover:text-gray-800 hover:bg-transparent"}
            ...
            <section className={"bg-secondary h-52 text-gray-200 flex-col-center justify-center"}>
                ...
                <button className={"bg-primary h-12 w-52 rounded-md text-white mt-8 text-sm uppercase font-semibold border-4 border-transparent hover:border-primary hover:bg-transparent"}
